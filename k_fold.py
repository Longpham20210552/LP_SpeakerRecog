...
from SR_Dataset import read_MFB, TruncatedInputfromMFB, ToTensorInput, ToTensorDevInput, DvectorDataset_2, collate_fn_feat_padded
#from model.model import background_resnet
import matplotlib.pyplot as plt
from model.Pretrained_ReDimNet import ReDimNetWithClassifier
#from model.Pretrained_ReDimNet import model 
from model.redimnet_u import ReDimNetWrap
...
def load_dataset_kfold_pytorch_new(TRAIN_FEAT_DIR, n_splits=8, fold_info_path="fold_info_unknown.json"):
    ...
    full_dataset = DvectorDataset_2(DB=train_valid_DB, loader=file_loader, transform=transform, spk_to_idx=spk_to_idx)
...
def main():
    ...
    lr = 0.1            # Learning_rate = 0.12
    wd = 1e-4                # Điều khoản phạt hàm mất mát
    optimizer_type = 'sgd'  # ex) sgd, adam, adagrad; chọn SGD làm phương pháp tối ưu
    batch_size = 64         # Kích thước batch training 
    ...
    log_dir = 'model_saved_kfold_embeddings_resnet' # Lưu checkpoints sau mỗi epoch
